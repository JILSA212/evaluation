# -*- coding: utf-8 -*-
"""google_statement_50_500.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/19YVi0pIW9u8QFH8YGY2bSJ_lVZN4KMsH
"""
...
# tokenizer = AutoTokenizer.from_pretrained("jilsa212/google_statement_50_500")

model = AutoModelForSeq2SeqLM.from_pretrained("jilsa212/google_statement_50_500")
...
# tokenizer = AutoTokenizer.from_pretrained("jilsa212/output2")

# model = AutoModelForSeq2SeqLM.from_pretrained("jilsa212/output2")
...
training_args = TrainingArguments(output_dir="./google_statement_50_500/", learning_rate=2e-5, per_device_train_batch_size=8, per_device_eval_batch_size=8, num_train_epochs=50, push_to_hub=True)
